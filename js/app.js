...
function agregarEstudiante() {
    ...
    // TO DO: Retornar el estudiante recientemente creado
      var nombre = prompt ("Ingrese nombre de la estudiante").toUpperCase ();
...
function buscar(nombre, estudiantes) {
  ...
  /*  var estudianteBuscado = [];
    nombre = nombre.toUpperCase();
    for (var i=0; i<estudiantes.length; i++){
      if (estudiantes[i].nombre == nombre){
        estudianteBuscado.push (estudiantes[i]);
        return estudianteBuscado;
      }
    }*/
    var estudianteBuscado = estudiantes.filter(function(alumno){
...
function topTecnico(estudiantes) {
    ...
    var ordenarPuntajeTecnico = estudiantes.sort(function (a,b){
      return b.puntosTecnicos - a.puntosTecnicos;
    });
    return ordenarPuntajeTecnico;

}

function topHSE(estudiantes) {
    // TO DO: Retornar el arreglo de estudiantes ordenado por puntaje de HSE de mayor a menor
    var ordenarHse = estudiantes.sort (function (a,b){
